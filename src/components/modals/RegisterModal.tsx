            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2">
                  ...
                  {problemStatement === 'ORION-PS-04' && (
                    <div className="mt-2.5 p-3 bg-amber-950/40 border border-amber-400/50 text-[11px] font-sans text-amber-200 flex items-start gap-2">
                      <AlertTriangle className="w-4 h-4 text-amber-400 shrink-0 mt-0.5" />
                      <div>
                        <span className="font-bold text-amber-300 font-mono">Notice on Open Innovation: </span>
                        The Open Innovation category is available <strong>only for Round 1 (shortlisting)</strong> and will <strong>not be available in the finals</strong>. All shortlisted teams must work on the problem statements provided on the spot for the final round.
                      </div>
                    </div>
                  )}
                </div>
