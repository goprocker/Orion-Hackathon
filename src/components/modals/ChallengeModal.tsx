      ...
      <div className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            {/* Open Innovation Clarification Notice */}
            {(problem.id === 'open-innovation' || problem.code === 'ORION-PS-04') && (
              <div className="p-4 bg-amber-950/40 border border-amber-400/50 text-amber-200 text-xs sm:text-sm font-sans rounded-none space-y-1 shadow-sm">
                <div className="flex items-center gap-2 text-amber-300 font-bold uppercase tracking-wider text-xs">
                  <AlertTriangle className="w-4 h-4 text-amber-400 shrink-0" />
                  <span>Clarification on Open Innovation</span>
                </div>
                <p>
                  The <strong>Open Innovation category is available only for Round 1 (shortlisting)</strong> and will <strong>not be available in the finals</strong>.
                </p>
                <p className="text-amber-300/90 text-xs">
                  All shortlisted teams must work on the <strong>problem statements provided on the spot</strong> for the final round, regardless of the category chosen in Round 1.
                </p>
              </div>
            )}
