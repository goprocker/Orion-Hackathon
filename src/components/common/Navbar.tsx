          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            {onOpenRegister ? (
              <button
                ...
                className="px-3.5 py-2 rounded-none font-sans font-bold text-xs text-[#020617] bg-gradient-to-r from-[#FFFFFF] via-[#BAE6FD] to-[#00BCF2] active:scale-95 transition-transform shadow-sm flex items-center justify-center cursor-pointer"
              >
                Register ₹100
              </button>
            ) : (
