              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                <div className="space-y-4 text-xs sm:text-sm text-slate-300 font-sans">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white block font-semibold text-sm">Standardized PPT Template (Mandatory)</strong>
                      Every team must submit its PPT by 11:00 on 11 September 2026 using the official template. Once submitted, PPTs cannot be edited or replaced.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-blue-400 shrink-0 mt-0.5" />
                    <div>
                      <strong className="text-white block font-semibold text-sm">AI Usage Policy (Max 10%)</strong>
                      A maximum of 10% AI usage is allowed. Usage beyond this limit is strictly prohibited.
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 text-xs sm:text-sm text-slate-300 font-sans">
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-blue-400 shrink-0 mt-0.5" />
                    <div>
                      <strong className="text-white block font-semibold text-sm">Demo Video & Repo Link (Optional)</strong>
                      Both the demo video and GitHub repo link are optional for Round 1. Only the PPT submission is mandatory.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-blue-400 shrink-0 mt-0.5" />
                    <div>
                      <strong className="text-white block font-semibold text-sm">Drive Folder Destination</strong>
                      Upload PPT only to the corresponding folder (PS1, PS2, PS3, or Open Innovation) in the shared submission Drive.
                    </div>
                  </div>
                </div>
              </div>
