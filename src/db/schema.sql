...
create table if not exists public.teams (
  ...
  -- Portal login handle: team_name lowercased with spaces and punctuation
  -- stripped, numerically suffixed when two squads pick the same name.
  -- Generated by trg_teams_username; see migrations/015.
...
create unique index if not exists idx_teams_username_lower on public.teams (lower(username));
