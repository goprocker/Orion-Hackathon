      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-8">
        ...
        {team && (
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            {/* OPEN INNOVATION SPECIAL NOTICE */}
            {(team.problem_statement?.includes('ORION-PS-04') || team.problem_statement?.toLowerCase().includes('open innovation')) && (
              <div className="p-4 bg-amber-950/50 border border-amber-400/60 flex items-start gap-3 text-xs text-amber-200">
                <AlertTriangle className="w-5 h-5 text-amber-400 shrink-0 mt-0.5" />
                <div className="space-y-1">
                  <div className="font-bold text-amber-300 font-mono-hud uppercase tracking-wider text-xs">
                    Clarification on Open Innovation Track
                  </div>
                  <p className="text-[11px] text-amber-100 font-sans leading-relaxed">
                    The <strong>Open Innovation category is available only for Round 1 (shortlisting)</strong> and will <strong>not be available in the finals</strong>. All shortlisted teams must work on the <strong>problem statements provided on the spot</strong> for the final round, regardless of the category chosen in Round 1.
                  </p>
                </div>
              </div>
            )}
